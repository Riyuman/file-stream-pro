...
‣ ɢᴇᴛ <a href="http://t.me/M_P_G_File_Provider_Bot">ᴍᴏʀᴇ ғɪʟᴇs |𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞|⬅️</a></b> 🤡"""
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Support [Support](https://t.me/Oogo_nick) They Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ Support** [Support](https://t.me/Movie_providing_group_bot)",
    ...
    try:
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("sᴛʀᴇᴀᴍ 🌐", url=stream_link), #Stream Link
                                                InlineKeyboardButton('ᴅᴏᴡɴʟᴏᴀᴅ ♻️', url=online_link)]]) #Download Link
        )
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    InlineKeyboardButton('ᴅᴏᴡɴʟᴏᴀᴅ ♻️', url=online_link)] 
                ]
            )
        )
